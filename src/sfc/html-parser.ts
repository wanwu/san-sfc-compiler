...
'x'.replace(/x(.)?/g, function (_, g) {
  if (g === '') IS_REGEX_CAPTURING_BROKEN = false;
  return '';
});

// Special Elements (can contain anything)
export const isPlainTextElement = makeMap('script,style,textarea', true);
const reCache = {} as { [key: string]: string | RegExp | any };
...
function decodeAttr(value: string, shouldDecodeNewlines: any) {
